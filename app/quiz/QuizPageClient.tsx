...
export default function QuizPageClient() {
  const [answers, setAnswers] = useState<string[]>(
    Array(expectedIssues.length).fill(""),
  );
    ...
    <div className="flex flex-col min-h-screen">
      <div className="fixed bottom-4 right-4 z-50">
        <button
          ...
          aria-label={
            goToAnswers
              ? "Jump to the answers section"
              : "Back to top of the quiz"
          }
        >
      ...
      >
        ...
        >
          <div className="max-w-7xl mx-auto px-4 py-6">
            ...
            <p className="text-lg text-yellow-900/90 mb-3">
              This page includes the same kinds of inaccessible patterns found
            ...
            <p className="text-gray-800 dark:text-gray-200">
              ...
              to examine the page structure, colors, labels, and keyboard
              behavior.
            </p>
          </div>
        </div>
        <section className="mb-12">
          ...
          <p className="text-gray-700 mb-4">
            Below are multiple examples of accessibility problems. The page
        ...
        <section className="mb-12">
          ...
          <div className="space-y-10">
            <div className="rounded-lg border border-gray-300 bg-gray-50 p-6">
              <p className="text-gray-700 mb-4">
                The elements below intentionally includes accessibility issues.
                Try to identify them without relying on labels or explanations.
              </p>

              <p className="text-red-700 mb-4">
                <strong>
                  There can be more than one issue per item, try to identify all
                  of them!
                </strong>
              </p>
              ...
              <div className="mb-8">
                ...
                <div className="flex gap-4">
                  <button
                    type="button"
                    className="px-3 py-2 bg-green-400 text-green-700 rounded"
                  >
                    <span>Accept</span>
                  </button>
                  <button
                    type="button"
                    className="px-3 py-2 bg-red-400 text-red-700 rounded"
                  >
                    <span>Decline</span>
                  </button>
                </div>
              ...
              <div className="mb-8">
                ...
                >
                  ...
                  <h3 className="text-xl font-bold mt-2 mb-1">
                    Historic accessibilty - pre-1900
                  </h3>
                  <p>
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed
                    do eiusmod tempor incididunt ut labore et dolore magna
                  ...
                  <h3 className="text-xl font-bold mt-2 mb-1">
                    The beginnings of accessibilty - 1900-1950
                  </h3>
                  <p>
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed
                    do eiusmod tempor incididunt ut labore et dolore magna
                  ...
                  <h4 className="text-lg font-bold mt-2 mb-1">
                    Ticket refinement & Acceptance Criteria
                  </h4>
                  <p>
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed
                    do eiusmod tempor incididunt ut labore et dolore magna
              ...
              <div className="absolute" style={{ left: "-1000px" }}>
                <div className="text-2xl font-bold mb-2">
                  Hidden text and element
                </div>
                <p>
                  You can't see this text, but it is acceptable to a screen
                  reader, and it&quot;s going to read it out.
                </p>
              </div>
      ...
      <footer className="bg-gray-800 text-white mt-12">
        <div className="max-w-7xl mx-auto px-4 py-8">
          <p className="text-sm text-gray-300">
            &copy; 2026 Accessibility Demo Site. Use this quiz to practice
            spotting accessibility problems.
          </p>
        </div>
      </footer>
    </div>

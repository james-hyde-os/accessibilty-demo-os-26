  ...
  const tools = [
    {
      ...
      documentation: [
        { title: "MDN Web Docs - Inspector", href: "https://developer.mozilla.org/en-US/docs/Tools/Inspector" }
      ],
      instructions: [
    ...
    },
    {
      ...
      documentation: [
        { title: "WebAIM Contrast Checker", href: "https://webaim.org/resources/contrastchecker/" }
      ],
      instructions: [
    ...
    },
    {
      ...
      documentation: [
        { title: "macOS VoiceOver", href: "https://www.apple.com/accessibility/voiceover/" },
        { title: "Windows Narrator", href: "https://support.microsoft.com/en-us/windows/use-narrator-to-read-and-respond-to-emails-d94215e5-f9d9-47b8-90c6-b3f3131e318a" }
      ],
      instructions: [
    ...
    },
    {
      ...
      documentation: [
        { title: "macOS Voice Control", href: "https://support.apple.com/en-us/102292" },
        { title: "Windows Voice Control", href: "https://support.microsoft.com/en-us/windows/voice-control-in-windows-11-efde6e24-8ecc-4bee-9cdd-ba76b752be4b" }
      ],
      instructions: [
    ...
    },
    {
      ...
      documentation: [
        { title: "WAVE Web Accessibility Evaluation Tool", href: "https://wave.webaim.org/" }
      ],
      instructions: [
      ...
      <main className="flex-1 max-w-7xl mx-auto px-4 py-12 w-full">
        <section className="mb-12">
          ...
          <p className="text-lg text-gray-700 mb-8">
            Click on any tool below to learn more about it, including documentation
            links and basic instructions on how to use it for accessibility testing.
          </p>
        ...
        <section className="bg-blue-50 p-6 rounded-lg border border-blue-200">
          ...
          <p className="text-gray-700 mb-4">
            We recommend starting with browser developer tools to understand HTML
            structure, then using automated tools like Axe DevTools or WAVE to
            identify issues. Finally, test with keyboard navigation and screen
            readers to verify the user experience.
          </p>
          <Link
            href="/"
